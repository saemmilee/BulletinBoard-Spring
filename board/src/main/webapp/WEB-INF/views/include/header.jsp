					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="/resources/dist/img/hss.jpg" class="user-image"
								alt="User Image" /> <span class="hidden-xs">SAEMMI</span>
						</a>
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header"><img
									src="/resources/dist/img/hss.jpg" class="img-circle"
									alt="User Image" />
									<p>
										201944077 3학년 C반 이샘미 <small>Member since Oct. 2016</small>
									</p></li>
								<!-- Menu Body -->
								<li class="user-body">
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="/resources/dist/img/hss.jpg" class="img-circle"
							alt="User Image" />
					</div>
